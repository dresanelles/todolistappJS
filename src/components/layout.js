    ...
    <div class="min-h-screen flex flex-col bg-slate-50 font-sans">
      ...
      <header class="bg-white border-b border-gray-100 flex flex-row justify-between items-center w-full px-4 md:px-8 py-4 sticky top-0 z-40 shadow-sm">
        ...
        <div class="flex items-center gap-3">
          ...
          <button id="btnLogoutGlobal" class="bg-red-500 hover:bg-red-50 hover:text-red-600 text-gray-100 text-xs md:text-sm font-semibold px-4 py-2 rounded-full cursor-pointer transition-colors active:scale-95">
            Logout
          </button>
        </div>
      </header>
